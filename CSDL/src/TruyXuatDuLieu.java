...
public class TruyXuatDuLieu extends JFrame implements ActionListener
{
    ...
    public static void setPASSWORD(String PASSWORD) {
        TruyXuatDuLieu.PASSWORD = PASSWORD;
    }
    ...
    JRadioButton rbSelect, rbInsert, rbDelete, rbSearch;
    JTable tb;
    JPanel pn1, pn2, pn3, pn4, pnRadio,  pn;
    String column[] = { "ID", "NAME", "ADDRESS", "TOTAL" };
    DefaultTableModel tableModel;

    public TruyXuatDuLieu(String st)
    {
        super(st);
        GUI();
    }
    public void GUI()
    {
        ...
        rbSearch.setBounds(100, 50, 100, 30);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if (e.getSource()==btnok)
        {
            ...
            try {
                ...
                if (rbSelect.isSelected() || rbSearch.isSelected()) {
    ...
    {
        new TruyXuatDuLieu("TRUY XUẤT DỮ LIỆU");
    }
}
